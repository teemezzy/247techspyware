...
const Footer = () => {
  return (
    <footer className="bg-secondary text-white p-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              />
              <button className="bg-primary hover:bg-[#c82333] text-white px-4 py-2 font-semibold transition-colors">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button className="bg-[#ffa500] hover:bg-[#ff8c00] text-white px-6 py-2 font-semibold w-fit transition-colors">
              Join Now
            </button>
          </div>
        </div>
